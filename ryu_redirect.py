...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        self.mac_to_port.setdefault(dpid,{'00:00:00:00:00:02':{}})
        self.mac_to_port[dpid]['00:00:00:00:00:02']=2
        ...
        if out_port != ofproto.OFPP_FLOOD:
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                #  if TCP Protocol
                    ...
                    if ('00:00:00:00:00:03' in self.mac_to_port[dpid]) & (src == '00:00:00:00:00:02'):

                        out_port = self.mac_to_port[dpid]['00:00:00:00:00:03']
                        print('dst', dst, 'out_port', out_port,'src',src)
                        actions = [parser.OFPActionSetField(eth_src='00:00:00:00:00:01'),
                                   ...
                                   parser.OFPActionSetField(ipv4_dst='10.0.1.5'),
                                   parser.OFPActionOutput(out_port)]
                        match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP, ipv4_dst = dstip)
                    elif ('00:00:00:00:00:02' in self.mac_to_port[dpid]) & (src == '00:00:00:00:00:03'):
